...
import { mulBpsCeil } from "../units/money";
...
export function capCostBase(expectedCostBase: bigint, intervalSec: number): bigint {
  return mulBpsCeil(expectedCostBase, costCapBufferBps(intervalSec));
}
