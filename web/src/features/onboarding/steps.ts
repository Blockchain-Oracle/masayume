...
export const TUTORIAL_UI = {
  ...
  choicePrompt: "First, how should the live Windows read?",
  plain: { title: "New to this", note: "Plain questions. Tap Yes or No and we keep the chart out of the way." },
  full: { title: "I trade", note: "Lines, live cents and the book. The full card." },
  lastStep: "Last step",
