...
export const RANGE = {
  ...
  band: {
    ...
    width: "Range width",
    span: (usd: number) => `$${usd} span`,
    center: "Range center",
    atMarket: "At market price",
    offMarket: (usd: number, above: boolean) => `$${usd} ${above ? "above" : "below"} market`,
    sliderLabel: (asset: string) => `Range center relative to the current ${asset} price`,
    sliderCentered: "Centered on market price",
    sliderOff: (usd: number, above: boolean) => `${usd} dollars ${above ? "above" : "below"} market price`,
    drag: "Drag to move the range",
    lower: "Move range five dollars lower",
    higher: "Move range five dollars higher",
