...
function ToastIcon({ type }: { type: string | undefined }) {
  ...
  if (type === "success") {
    icon = (
      <CircleCheckIcon className="text-profit" aria-hidden="true" />
    )
  }

  if (type === "info") {
    icon = (
      <InfoIcon className="text-ink-muted" aria-hidden="true" />
    )
  }
  ...
  if (type === "error") {
    icon = (
      <OctagonXIcon className="text-loss" aria-hidden="true" />
    )
  }
